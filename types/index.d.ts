...
export declare function fetchAccountTokensAsociated(
  account: string
): Promise<any>;
export declare function fetchAccountNFTs(
  account: string,
  {
    tokenId,
    tokenIdOperator,
...
export declare function fetchBalances({
  accountId,
  accountIdOperator,
  balance,
  balanceOperator,
...
export declare function fetchTransactions({
  accountId,
  accountIdOperator,
  timestamp,
  result,
...
export declare function fetchTransactionsAccount(
  account: string,
  filters?: {
    timestamp?: string;
    result?: "success" | "fail";
...
export declare function fetchTopicMessageBySequenceNumber(
  topicId: string,
  sequenceNumber: number
): Promise<any>;
export declare function fetchTopicMessageByTimestamp(
  timestamp: string
): Promise<any>;
...
export declare function fetchTokenBalances(
  tokenId: string,
  {
    accountId,
    accountIdOperator,
...
export declare function fetchTokenNfts(
  tokenId: string,
  {
    accountId,
    limit,
...
export declare function fetchTokenNftSerialNumber(
  tokenId: string,
  serialNumber: string
): Promise<any>;
export declare function fetchNftTransactionHistory(
  tokenID: string,
  serialNumber: string,
  {
    limit,
...
export declare function fetchContracts({
  contractId,
  limit,
  order,
}?: {
