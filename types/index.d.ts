...
export declare function fetchNftColection(): Promise<void>;
export declare function fetchTransactionHistoryNftColection(): Promise<void>;
export declare function fetchTopHoldersNftColection(): Promise<void>;
export declare function fetchFloorPriceNftColection(): Promise<void>;
export declare function fetchVolumeNftColection(): Promise<void>;
export declare function fetchCapMarketNftColection(): Promise<void>;
export declare function fetchSocialMediaNftColection(): Promise<void>;
export declare function fetchTradingDataNftColection(): Promise<void>;
export declare function fetchNft(): Promise<void>;
export declare function fetchTransactionHistoryNft(): Promise<void>;
export declare function fetchFloorPriceNft(): Promise<void>;
export declare function fetchCoin(): Promise<void>;
export declare function fetchTransactionHistoryCoin(): Promise<void>;
export declare function fetchTopHolderCoin(): Promise<void>;
export declare function fetchFloorPriceCoin(): Promise<void>;
export declare function fetchVolumeCoin(): Promise<void>;
export declare function fetchCapMarketCoin(): Promise<void>;
export declare function fetchSocialMediaCoin(): Promise<void>;
export declare function fetchTradingDataCoin(): Promise<void>;
